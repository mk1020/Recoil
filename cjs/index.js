...
const env = {
  ...
  RECOIL_GKS_ENABLED: new Set(['recoil_hamt_2020', 'recoil_sync_external_store', 'recoil_suppress_rerender_in_callback', 'recoil_memory_managament_2020', 'recoil_transition_support'])
};
...
function currentRendererSupportsUseSyncExternalStore() {
  try {
    ...
    const internals = react.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED; // React 19 changed the internal structure
    ...
    if (!ReactCurrentDispatcher) {
      ...
      if (!ReactRendererVersionMismatchWarnOnce) {
        ...
        Recoil_recoverableViolation('Recoil: Unable to detect React dispatcher, assuming useSyncExternalStore is supported', 'recoil');
      }

      return true;
    }

    const dispatcher = (_ReactCurrentDispatch = ReactCurrentDispatcher === null || ReactCurrentDispatcher === void 0 ? void 0 : ReactCurrentDispatcher.current) !== null && _ReactCurrentDispatch !== void 0 ? _ReactCurrentDispatch : ReactCurrentOwner && ReactCurrentOwner.currentDispatcher;
    const isUseSyncExternalStoreSupported = dispatcher && dispatcher.useSyncExternalStore != null;

    if (useSyncExternalStore && !isUseSyncExternalStoreSupported && !ReactRendererVersionMismatchWarnOnce) {
      ReactRendererVersionMismatchWarnOnce = true;
      Recoil_recoverableViolation('A React renderer without React 18+ API support is being used with React 18+.', 'recoil');
    }
    ...
    if (!ReactRendererVersionMismatchWarnOnce) {
      ReactRendererVersionMismatchWarnOnce = true;
      Recoil_recoverableViolation(`Recoil: Unable to detect React renderer version, assuming useSyncExternalStore is supported. Error: ${error.message}`);
    }
...
function getPercentage(prevented, attempted) {
  if (attempted === 0) return '0';
  return (prevented / attempted * 100).toFixed(1);
}

var Recoil_PerformanceStats = {
  enableLogging,
  isLoggingEnabled,
  logAtomUpdate,
...
function atomicUpdaterDeferred(store, options) {
  return fn => {
    const executeUpdate = () => {
    ...
    if (options !== null && options !== void 0 && options.waitForInteractions) {
      try {
        ...
        console.log('InteractionManager is not supported'); // Not in React Native environment, continue without InteractionManager
      }
    }
...
var Recoil_AtomicUpdates = {
  atomicUpdater,
  atomicUpdaterDeferred
};

var Recoil_AtomicUpdates_1 = Recoil_AtomicUpdates.atomicUpdater;
var Recoil_AtomicUpdates_2 = Recoil_AtomicUpdates.atomicUpdaterDeferred;

var Recoil_AtomicUpdates$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  atomicUpdater: Recoil_AtomicUpdates_1,
  atomicUpdaterDeferred: Recoil_AtomicUpdates_2
});
...
const {
  ...
  atomicUpdaterDeferred: atomicUpdaterDeferred$1
...
function recoilCallback(store, fn, args, extraInterface) {
  ...
  batchUpdates$4(() => {
    ...
    const callbackInterface = Recoil_lazyProxy({ ...(extraInterface !== null && extraInterface !== void 0 ? extraInterface : {}),
      ...
      // $FlowFixMe[missing-local-annot]
      transactDeferred_UNSTABLE: (transaction, options) => atomicUpdaterDeferred$1(store, options)(transaction)
    }, {
      snapshot: () => {
...
function baseAtom(options) {
  ...
  function setAtom(_store, state, newValue) {
    ...
    if (state.atomValues.has(key)) {
      ...
      const isEqual = newValue === existing.contents || fastDeepEqual(newValue, existing.contents);

      if (existing.state === 'hasValue' && isEqual) {
        if (process.env.NODE_ENV !== "production") {
          logAtomUpdate$1(key, true);
        }

        return new Map();
      }

      if (process.env.NODE_ENV !== "production" && existing.state === 'hasValue') {
...
var Recoil_index = {
  ...
  RecoilPerformanceStats: Recoil_PerformanceStats,
  // Recoil Root
  RecoilRoot: RecoilRoot$2,
  useRecoilStoreID: useRecoilStoreID$1,
...
var Recoil_index_5 = Recoil_index.RecoilPerformanceStats;
var Recoil_index_6 = Recoil_index.RecoilRoot;
var Recoil_index_7 = Recoil_index.useRecoilStoreID;
var Recoil_index_8 = Recoil_index.useRecoilBridgeAcrossReactRoots_UNSTABLE;
var Recoil_index_9 = Recoil_index.atom;
var Recoil_index_10 = Recoil_index.selector;
var Recoil_index_11 = Recoil_index.atomFamily;
var Recoil_index_12 = Recoil_index.selectorFamily;
var Recoil_index_13 = Recoil_index.constSelector;
var Recoil_index_14 = Recoil_index.errorSelector;
var Recoil_index_15 = Recoil_index.readOnlySelector;
var Recoil_index_16 = Recoil_index.noWait;
var Recoil_index_17 = Recoil_index.waitForNone;
var Recoil_index_18 = Recoil_index.waitForAny;
var Recoil_index_19 = Recoil_index.waitForAll;
var Recoil_index_20 = Recoil_index.waitForAllSettled;
var Recoil_index_21 = Recoil_index.useRecoilValue;
var Recoil_index_22 = Recoil_index.useRecoilValueLoadable;
var Recoil_index_23 = Recoil_index.useRecoilState;
var Recoil_index_24 = Recoil_index.useRecoilStateLoadable;
var Recoil_index_25 = Recoil_index.useSetRecoilState;
var Recoil_index_26 = Recoil_index.useResetRecoilState;
var Recoil_index_27 = Recoil_index.useGetRecoilValueInfo_UNSTABLE;
var Recoil_index_28 = Recoil_index.useRecoilRefresher_UNSTABLE;
var Recoil_index_29 = Recoil_index.useRecoilValueLoadable_TRANSITION_SUPPORT_UNSTABLE;
var Recoil_index_30 = Recoil_index.useRecoilValue_TRANSITION_SUPPORT_UNSTABLE;
var Recoil_index_31 = Recoil_index.useRecoilState_TRANSITION_SUPPORT_UNSTABLE;
var Recoil_index_32 = Recoil_index.useRecoilCallback;
var Recoil_index_33 = Recoil_index.useRecoilTransaction_UNSTABLE;
var Recoil_index_34 = Recoil_index.useGotoRecoilSnapshot;
var Recoil_index_35 = Recoil_index.useRecoilSnapshot;
var Recoil_index_36 = Recoil_index.useRecoilTransactionObserver_UNSTABLE;
var Recoil_index_37 = Recoil_index.snapshot_UNSTABLE;
var Recoil_index_38 = Recoil_index.useRetain;
var Recoil_index_39 = Recoil_index.retentionZone;

exports.DefaultValue = Recoil_index_1;
exports.RecoilEnv = Recoil_index_4;
exports.RecoilLoadable = Recoil_index_3;
exports.RecoilPerformanceStats = Recoil_index_5;
exports.RecoilRoot = Recoil_index_6;
exports.atom = Recoil_index_9;
exports.atomFamily = Recoil_index_11;
exports.constSelector = Recoil_index_13;
exports.default = Recoil_index;
exports.errorSelector = Recoil_index_14;
exports.isRecoilValue = Recoil_index_2;
exports.noWait = Recoil_index_16;
exports.readOnlySelector = Recoil_index_15;
exports.retentionZone = Recoil_index_39;
exports.selector = Recoil_index_10;
exports.selectorFamily = Recoil_index_12;
exports.snapshot_UNSTABLE = Recoil_index_37;
exports.useGetRecoilValueInfo_UNSTABLE = Recoil_index_27;
exports.useGotoRecoilSnapshot = Recoil_index_34;
exports.useRecoilBridgeAcrossReactRoots_UNSTABLE = Recoil_index_8;
exports.useRecoilCallback = Recoil_index_32;
exports.useRecoilRefresher_UNSTABLE = Recoil_index_28;
exports.useRecoilSnapshot = Recoil_index_35;
exports.useRecoilState = Recoil_index_23;
exports.useRecoilStateLoadable = Recoil_index_24;
exports.useRecoilState_TRANSITION_SUPPORT_UNSTABLE = Recoil_index_31;
exports.useRecoilStoreID = Recoil_index_7;
exports.useRecoilTransactionObserver_UNSTABLE = Recoil_index_36;
exports.useRecoilTransaction_UNSTABLE = Recoil_index_33;
exports.useRecoilValue = Recoil_index_21;
exports.useRecoilValueLoadable = Recoil_index_22;
exports.useRecoilValueLoadable_TRANSITION_SUPPORT_UNSTABLE = Recoil_index_29;
exports.useRecoilValue_TRANSITION_SUPPORT_UNSTABLE = Recoil_index_30;
exports.useResetRecoilState = Recoil_index_26;
exports.useRetain = Recoil_index_38;
exports.useSetRecoilState = Recoil_index_25;
exports.waitForAll = Recoil_index_19;
exports.waitForAllSettled = Recoil_index_20;
exports.waitForAny = Recoil_index_18;
exports.waitForNone = Recoil_index_17;
