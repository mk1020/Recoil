...
var deepObjectDiff = _interopDefault(require('deep-object-diff'));
...
function currentRendererSupportsUseSyncExternalStore() {
  try {
    ...
    const internals = react.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED; // Check if internals exist (may be undefined in some React Native builds)
